...
public class ResourceGuiRemoveProcedure extends WorldtriggercraftModElements.ModElement {
	public ResourceGuiRemoveProcedure(WorldtriggercraftModElements instance) {
		super(instance, 23);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure ResourceGuiRemove!");
			return;
		}
