...
import net.mcreator.worldtriggercraft.procedures.ChangeTriggerShapePressedProcedure;
...
public class ChangeTriggerShapeKeyBinding extends WorldtriggercraftModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public ChangeTriggerShapeKeyBinding(WorldtriggercraftModElements instance) {
		super(instance, 50);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.change_trigger_shape", GLFW.GLFW_KEY_V, "key.categories.world_trigger_keys");
		...
		if (type == 0) {
			{
				...
				ChangeTriggerShapePressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
