...
public class RaycastItem extends WorldtriggercraftModElements.ModElement {
	@ObjectHolder("worldtriggercraft:raygust")
	public static final Item block = null;
	public RaycastItem(WorldtriggercraftModElements instance) {
		super(instance, 27);
	}
		...
		public Multimap<String, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot) {
			...
			if (slot == EquipmentSlotType.MAINHAND) {
				multimap.put(SharedMonsterAttributes.ATTACK_DAMAGE.getName(),
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "item_damage", (double) 7, AttributeModifier.Operation.ADDITION));
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Raygust");
					}
