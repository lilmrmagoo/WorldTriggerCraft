...
public class TriggerCircuitItem extends WorldtriggercraftModElements.ModElement {
	@ObjectHolder("worldtriggercraft:trigger_circuit")
	public static final Item block = null;
	public TriggerCircuitItem(WorldtriggercraftModElements instance) {
		super(instance, 7);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("trigger_circuit");
		}
