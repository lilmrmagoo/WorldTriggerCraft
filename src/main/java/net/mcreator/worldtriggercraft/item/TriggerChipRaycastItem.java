...
public class TriggerChipRaycastItem extends WorldtriggercraftModElements.ModElement {
	@ObjectHolder("worldtriggercraft:trigger_chip_raycast")
	public static final Item block = null;
	public TriggerChipRaycastItem(WorldtriggercraftModElements instance) {
		super(instance, 11);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("trigger_chip_raycast");
		}
