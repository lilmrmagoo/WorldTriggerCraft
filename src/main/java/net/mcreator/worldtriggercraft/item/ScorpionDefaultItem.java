...
public class ScorpionDefaultItem extends WorldtriggercraftModElements.ModElement {
	@ObjectHolder("worldtriggercraft:scorpion_default")
	public static final Item block = null;
	public ScorpionDefaultItem(WorldtriggercraftModElements instance) {
		super(instance, 51);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("scorpion_default");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Scorpion");
					}
