...
public class BlankTriggerChipItem extends WorldtriggercraftModElements.ModElement {
	@ObjectHolder("worldtriggercraft:blank_trigger_chip")
	public static final Item block = null;
	public BlankTriggerChipItem(WorldtriggercraftModElements instance) {
		super(instance, 9);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("blank_trigger_chip");
		}
