...
public class TriggercaseBlackItem extends WorldtriggercraftModElements.ModElement {
	@ObjectHolder("worldtriggercraft:triggercase_black")
	public static final Item block = null;
	public TriggercaseBlackItem(WorldtriggercraftModElements instance) {
		super(instance, 4);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("triggercase_black");
		}
